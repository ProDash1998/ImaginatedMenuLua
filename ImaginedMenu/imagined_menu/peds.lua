...
ped.models = {
    ...
    {"ig_vernon",utils.joaat("ig_vernon")},
    {"csb_security_a",utils.joaat("csb_security_a")},
    {"s_m_m_studioassist_02",utils.joaat("s_m_m_studioassist_02")},
    {"csb_jio_02",utils.joaat("csb_jio_02")},
    {"csb_party_promo",utils.joaat("csb_party_promo")},
    {"ig_lamardavis_02",utils.joaat("ig_lamardavis_02")},
    {"ig_golfer_a",utils.joaat("ig_golfer_a")},
    {"csb_vernon",utils.joaat("csb_vernon")},
    {"ig_soundeng_00",utils.joaat("ig_soundeng_00")},
    {"csb_req_officer",utils.joaat("csb_req_officer")},
    {"csb_johnny_guns",utils.joaat("csb_johnny_guns")},
    {"ig_entourage_a",utils.joaat("ig_entourage_a")},
    {"ig_johnny_guns",utils.joaat("ig_johnny_guns")},
    {"ig_imani",utils.joaat("ig_imani")},
    {"csb_ballas_leader",utils.joaat("csb_ballas_leader")},
    {"a_f_y_studioparty_02",utils.joaat("a_f_y_studioparty_02")},
    {"a_m_m_studioparty_01",utils.joaat("a_m_m_studioparty_01")},
    {"g_m_m_goons_01",utils.joaat("g_m_m_goons_01")},
    {"ig_billionaire",utils.joaat("ig_billionaire")},
    {"a_m_y_studioparty_01",utils.joaat("a_m_y_studioparty_01")},
    {"ig_vincent_3",utils.joaat("ig_vincent_3")},
    {"csb_ary_02",utils.joaat("csb_ary_02")},
    {"ig_req_officer",utils.joaat("ig_req_officer")},
    {"a_f_y_studioparty_01",utils.joaat("a_f_y_studioparty_01")},
    {"s_f_m_studioassist_01",utils.joaat("s_f_m_studioassist_01")},
    {"cs_lamardavis_02",utils.joaat("cs_lamardavis_02")},
    {"s_m_m_studiosoueng_02",utils.joaat("s_m_m_studiosoueng_02")},
    {"csb_golfer_b",utils.joaat("csb_golfer_b")},
    {"p_franklin_02",utils.joaat("p_franklin_02")},
    {"s_m_m_studioprod_01",utils.joaat("s_m_m_studioprod_01")},
    {"csb_soundeng_00",utils.joaat("csb_soundeng_00")},
    {"csb_billionaire",utils.joaat("csb_billionaire")},
    {"ig_party_promo",utils.joaat("ig_party_promo")},
    {"csb_musician_00",utils.joaat("csb_musician_00")},
    {"s_m_m_highsec_05",utils.joaat("s_m_m_highsec_05")},
    {"ig_security_a",utils.joaat("ig_security_a")},
    {"csb_mjo_02",utils.joaat("csb_mjo_02")},
    {"ig_entourage_b",utils.joaat("ig_entourage_b")},
    {"ig_ary_02",utils.joaat("ig_ary_02")},
    {"ig_golfer_b",utils.joaat("ig_golfer_b")},
    {"ig_vagos_leader",utils.joaat("ig_vagos_leader")},
    {"ig_mjo_02",utils.joaat("ig_mjo_02")},
    {"csb_imani",utils.joaat("csb_imani")},
    {"ig_musician_00",utils.joaat("ig_musician_00")},
    {"csb_vagos_leader",utils.joaat("csb_vagos_leader")},
    {"ig_ballas_leader",utils.joaat("ig_ballas_leader")},
    {"ig_jio_02",utils.joaat("ig_jio_02")},
    {"csb_golfer_a",utils.joaat("csb_golfer_a")},
...
function ped.apply_outfit(components, props, ped)
    ...
    do
        PED.SET_PED_COMPONENT_VARIATION(ped, k, v[1], v[2], 0)
    end
    for k, v in pairs(props)
    do
        if v[1] == -1 then
            PED.CLEAR_PED_PROP(ped, k)
        else
            PED.SET_PED_PROP_INDEX(ped, k, v[1], v[2], true)
        end
    end
end
