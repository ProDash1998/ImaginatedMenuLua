...
do
    table.insert(ped.models, line)
    if line:find("^a_f_") then
        table.insert(ped.sorted[1], line)
    elseif line:find("^a_m_") then
        table.insert(ped.sorted[2], line)
    elseif line:find("^a_c_") then
        table.insert(ped.sorted[3], line)
    elseif line:find("^cs") then
        table.insert(ped.sorted[4], line)
    elseif line:find("^g_f_") then
        table.insert(ped.sorted[5], line)
    elseif line:find("^g_m_") then
        table.insert(ped.sorted[6], line)
    elseif line:find("^mp_") then
        table.insert(ped.sorted[7], line)
    elseif line:find("^s_f_") then
        table.insert(ped.sorted[8], line)
    elseif line:find("^s_m_") then
        table.insert(ped.sorted[9], line)
    elseif line:find("^hc_") or line:find("^ig_") then
        table.insert(ped.sorted[10], line)
    elseif line:find("^u_f_") then
        table.insert(ped.sorted[11], line)
    elseif line:find("^u_m_") then
        table.insert(ped.sorted[12], line)
    else
        table.insert(ped.sorted[13], line)
    end
end
